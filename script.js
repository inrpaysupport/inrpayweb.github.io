...
// Filling User Data in Home and Settings
...
loadUser();
loadSettings(); // Sync notice and deposit info
};
...
if(get("newPass").value!==get("confirmPass").value) return showMsg("Password mismatch");
